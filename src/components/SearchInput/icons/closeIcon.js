...
const CloseIcon = ({onclick}) => (
  <SvgIcon onClick={onclick} className="icon_close">
    <svg alt="Clear" focusable="false" enableBackground="new 0 0 13 13" viewBox="0 0 13 13"
         xmlns="http://www.w3.org/2000/svg" className="magic-box-clear-svg">
      <g fill="currentColor">
        <path
